 ...
 * concepto BEBEDOR de Parranderos
...
class SQLBebedor {
	...
	/**
	 * Crea y ejecuta la sentencia SQL para encontrar la información de LOS
	 * BEBEDORES Y DE SUS VISITAS REALIZADAS de la
	 * base de datos de Parranderos
	 * 
	 * @param pm        - El manejador de persistencia
	 * @param idBebedor - El identificador del bebedor
	 * @return Una lista de arreglos de objetos, de tamaño 7. Los elementos del
	 *         arreglo corresponden a los datos de
	 *         los bares visitados y los datos propios de la visita:
	 *         (id, nombre, ciudad, presupuesto, cantsedes) de los bares y
	 *         (fechavisita, horario) de las visitas
	 */
	...
	/**
	 * Crea y ejecuta la sentencia SQL para encontrar la información de LOS
	 * BEBEDORES Y DE LAS BEBIDAS QUE GUSTA de la
	 * base de datos de Parranderos
	 * 
	 * @param pm        - El manejador de persistencia
	 * @param idBebedor - El identificador del bebedor
	 ...
	 *         arreglo corresponden a los datos de
	 *         las bebidas (con el nombre del tipo de bebida) que le gustan al
	 *         bebedor:
	 *         (id, nombre, idtipobebida, gradoalcohol) de la bebida y el (nombre)
	 *         del tipo de bebida
	 */
	...
	/**
	 * Crea y ejecuta la sentencia SQL para encontrar la información de LOS
	 * BEBEDORES Y DE CUÁNTAS VISITAS HA REALIZADO de la
	 * base de datos de Parranderos. Incluye, con 0, los bebedores que no han
	 * realizado visitas
	 * 
	 * @param pm - El manejador de persistencia
	 * @return Una lista de arreglos de objetos, de tamaño 5. Los elementos del
	 *         arreglo corresponden a los datos del bebedor,
	 ...
	 * una ciudad que visitan bares de la
	 * base de datos de Parranderos
	 * 
	 * @param pm     - El manejador de persistencia
	 ...
	 * En caso que el bebedor esté referenciado por otra relación, NO SE BORRA NI EL
	 * BEBEDOR, NI SUS VISITAS
	...
	/**
	 * Crea y ejecuta la sentencia SQL para encontrar la información de LOS
	 * BEBEDORES Y DE CUÁNTOS BARES VISITAN de la
	 * base de datos de Parranderos. Incluye, con 0, los bebedores que no han
	 * realizado visitas
	 * 
	 * @param pm - El manejador de persistencia
