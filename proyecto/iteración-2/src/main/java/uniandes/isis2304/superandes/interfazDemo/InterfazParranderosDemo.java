...
public class InterfazParranderosDemo extends JFrame implements ActionListener {
	 ...
	 * Incluye también los tipos de bebida pues el tipo de bebida es llave foránea
	 * en las bebidas
	 * Muestra la traza de la ejecución en el panelDatos
	 * 
	 * Pre: La base de datos está vacía
	 ...
	 * vacía antes de la fase de limpieza
	 * Muestra la traza de la ejecución en el panelDatos
	 * 
	 * Pre: La base de datos está vacía
	 * Post: La base de datos está vacía
	 ...
	 * bar, siempre y cuando el bar sirva por los menos una bebida
	 * Incluye el manejo de los tipos de bebida pues el tipo de bebida es llave
	 * foránea en las bebidas
	 ...
	 * borrado de un bebedor y sus visitas
	 ...
	 * Demostración de creación, consulta de TODA LA INFORMACIÖN de un bebedor y
	 * borrado de un bebedor y sus visitas.
	 * Si hay posibilidades de alguna incoherencia con esta operación NO SE BORRA NI
	 * EL BEBEDOR NI SUS VISITAS
	 * Incluye el manejo de tipos de bebida
	 * Incluye el manejo de bebidas
	 * Incluye el manejo de bares
	 * Incluye el manejo de la relación sirven
	 ...
	 * 
	 * Pre: La base de datos está vacía
	 * Post: La base de datos queda con las tuplas que no se pudieron borrar: ES
	 * COHERENTE DE TODAS MANERAS
	 */
	 ...
	 * Demostración de creación, consulta de TODA LA INFORMACIÖN de un bebedor y
	 * borrado de un bebedor y sus visitas
	 * Si hay posibilidades de alguna incoherencia con esta operación SE BORRA LO
