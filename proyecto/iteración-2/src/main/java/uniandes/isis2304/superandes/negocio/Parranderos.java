...
public class Parranderos {
	 ...
	 * @param idBebedor - El identificador del bebedor buscado
	 * @return Un objeto Bebedor que corresponde con el identificador buscado y
	 *         lleno con su información básica y
	 ...
	 * que han realizado por lo menos una visita a un bar
	 * Adiciona entradas al log de la aplicación
	 * 
	 ...
	 * En caso que el bebedor esté referenciado por otra relación, EL BEBEDOR NO SE
	 * BORRA. PERO SUS VISITAS SÍ
	 * Adiciona entradas al log de la aplicación
	 * 
	 * @param idBebedor - El bebedor que se quiere eliminar
	 * @return Una pareja de números [número de bebedores eliminados, número de
