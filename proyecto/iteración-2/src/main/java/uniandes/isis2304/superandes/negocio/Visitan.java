 ...
 * Cada objeto de esta clase representa el hecho que un bebedor visitó un bar y
 * viceversa.
 ...
 * Adicionalmente contiene la fecha y el horario (DIURNO, NOCTURNO, TODOS) en el
 * cual el bebedor visitó el bar
 * 
 * @author Germán Bravo
 */
