 ...
 * concepto SIRVEN de Parranderos
...
class SQLSirven {
	 ...
	 * de bebidas que sirven los bares de la
	 * base de datos de Parranderos
	 * 
	 * @param pm - El manejador de persistencia
	 * @return Una lista de parejas de objetos, el primer elemento de cada pareja
	 *         representa el identificador de un bar,
	 *         el segundo elemento representa el número de bebidas que sirve (Una
	 *         bebida que se sirve en dos horarios cuenta dos veces)
	 */
