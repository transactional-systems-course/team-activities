...
public class Bebedor implements VOBebedor {
	 ...
	 * Cada visita es una tripleta de objetos [Bar, Timestamp, String], que
	 * representan el bar, la fecha
	 ...
	 * Cada visita es una pareja de objetos [Bebida, String], que representan la
	 * bebida y el nombre del
