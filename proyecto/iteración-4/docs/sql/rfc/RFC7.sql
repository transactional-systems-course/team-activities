...
CREATE VIEW MAYOR_DEMANDA AS
    SELECT CODIGO_BARRAS,
        NOMBRE,
        NULL                         AS DINERO_ADQUIRIDO,
        SUM(CANT_UNIDADES_COMPRADAS) AS CANTIDADES_ADQUIRIDAS,
        'MAYOR DEMANDA'              AS CATEGORIA,
        ID_SUCURSAL
    FROM DATOS_COMPRAS
...
FROM ( ((
        SELECT CODIGO_BARRAS,
            NOMBRE,
            SUM(VALOR_COMPRA_TOTAL)      AS DINERO_ADQUIRIDO,
            NULL                         AS CANTIDADES_ADQUIRIDAS,
